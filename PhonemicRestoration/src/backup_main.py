...
class Deep_Neural_Network():
    def __init__(self):
        ...
        self.artic = 'artic/space/'             # type of testing audio - noise or space / type of whether using articulatory data or not
        self.test_number = 0
    ...
    def _testing_DNN(self):        
        ...
        for type_test in sorted(os.listdir(test_dir)):
            if not type_test.endswith('zip'):
                ...
                print type_test_dir
                dnn_predict_dir = '/home/danglab/3P/' + self.hidden_layer +'SQR/' + self.artic + 'test_' + str(self.test_number) + '/' + type_test + '/'
