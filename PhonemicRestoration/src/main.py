    ...
    def _testing_noise_space(self, test_dir, type_data):             
        for type_test in sorted(os.listdir(test_dir)):
            if (not type_test.endswith('zip')) and 'output' not in type_test:                
                ...
                print type_test_dir
                dnn_predict_dir = '/home/danglab/Results/PhonemicRestoration/' + self.hidden_layer + type_data + 'SP_no_EMA/'+'test_' + str(self.test_number) + '/' + type_test + '/'
