...
class AudioPreProcessing():
    ...
    def _mat_pre_processing(self):
        ...
        #conver to z_scores
        self.position = self._convert_2_z_scores(self.position)
        self.velocity_pos = self._convert_2_z_scores(velocity)
        self.acceleration_pos = self._convert_2_z_scores(acceleration)
...
print au.velocity_mfcc.shape
print au.acceleration_mfcc.shape
