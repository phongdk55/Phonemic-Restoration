...
def read_afile(filename, num_features, arr):
    ...
    for line in input_file:
        ...
        if len(sequential_number) > num_features: 
            ...
            feature[0:13] = feature[0:13] * factor
            arr.append(feature)           
        else:
            factor = float(sequential_number[0])
...
def read_features(test_number, n_input, n_output):
    ...
    #feature_in_dir = '/home/danglab/Phong/features_3p/Noise/0_100ms_1_-6dB/'
    feature_out_dir = '/home/danglab/Phong/features_3p/origin/input/'
    ...
    for line in file_test:  # data train
        ...
        if 'usctimit_ema_f5_171_175' not in filename:
            #print filename
            input_file = feature_in_dir + filename.replace("_in",'_100ms_in')
